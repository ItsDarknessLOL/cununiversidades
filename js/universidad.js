...
fetch("../data/universidades.json")
  ...
  .then(data => {
    ...
    if (uni) render(uni);const params = new URLSearchParams(window.location.search);
const id = Number(params.get("id"));
...
function render(u) {
  ...
  document.getElementById("web").href = u.web || "No disponible";
  document.getElementById("facebook").href = u.facebook || "No disponible";
